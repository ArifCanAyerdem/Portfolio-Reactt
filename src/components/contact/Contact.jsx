...
const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_sq0iko1', 'template_sclc31g', formRef.current, {
        publicKey: '70DZuA_ckbrwr1QBm',
      })
      .then(
        () => {
          setSuccess(true);
  ...
  return (
    ...
    ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
     ...
     <svg width="450px" height="450px" viewBox="0 0 32.666 32.666">
        ...
        ref={formRef}
        onSubmit={sendEmail}
        initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:3.5,duration:1}}>
